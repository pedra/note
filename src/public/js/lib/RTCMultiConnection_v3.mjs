'use strict';
import FileProgressBarHandler from './FileProgressBarHandlers.mjs'
...
var RTCMultiConnection = function(roomid, forceOptions) {
    ...
    function MultiPeers(connection) {
        ...
        this.getReceivers = function(remoteUserId) {
    ...
    function PeerInitiator(config) {
        ...
        if (!peer.getReceivers && peer.getReceivers) {
            peer.getReceivers = function() {
        ...
        if (!peer.getSenders && peer.getSenders) {
            peer.getSenders = function() {
                var stream = new MediaStream();
        ...
        localStreams.forEach(function(localStream) {
            ...
            peer.getSenders().forEach(function(stream) {
    ...
    (function(connection) {
        ...
        connection.onstream = function(e) {
			if (!connection.autoCreateMediaElement) return
        ...
        connection.setStreamEndHandler = function(stream, isRemote) {
            ...
            stream.addEventListener(streamEndedEvent, function() {
                ...
                if (isRemote && connection.peers[streamEvent.userid]) {
                    ...
                    var streams = [];
                    peer.getReceivers().forEach(function(s) {
                        if (s.id != stream.id) {
                            streams.push(s);
                        }
                    });
        ...
        connection.getReceivers = mPeer.getReceivers;
